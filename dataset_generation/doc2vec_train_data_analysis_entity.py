...
print("paths with target: %s"  % len(train_data_with_target))
...
with open("out_taraget_%s.txt" % target_entity_id, "w") as fh:
    for i in range(len(counted_trained_items)):
