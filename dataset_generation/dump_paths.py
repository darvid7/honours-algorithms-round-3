...
if __name__ == "__main__":
    PATH_DUMP_PATH = "../../honours-data-round-2/FB15K/paths_random_test"
    KG_DUMP_PATH = "../../honours-data-round-2/FB15K/dumps/FB15K_PTransE_dump.pkl"
    NUM_PATHS_PER_ENTITY_COUNT = 1000000
    ENTITY_COUNTS = [3, 4, 5]
    ...
    dump_paths(path_dump_dir=PATH_DUMP_PATH, knowledg_graph=kg,
